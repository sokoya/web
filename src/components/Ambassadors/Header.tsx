  ...
  return (
    <>
      <section className="pt-32 sm:pt-36 md:pt-40 lg:pt-36">
        <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0 pb-[140px]">
  ...
  <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
    <div className="space-y-6 md:flex lg:items-center lg:gap-6 lg:space-y-0">
      ...
      <div className="md:7/12 lg:w-6/12">
        <h2 className="text-3xl font-bold text-gray-800 dark:text-white md:text-4xl xl:text-5xl" style={{fontSize: "3.3rem", letterSpacing: "-1px", lineHeight: '1.25', color: "#082552"}}>How our selection works.</h2>
        <p className="mt-8 mb-[30px] text-gray-600 dark:text-gray-300" style={{color: "rgba(8,37,82,.6)!important", fontSize: "1.3rem"}}>Open applications will be invited from individuals who demonstrate a genuine interest in personal finance and possess knowledge and experience in budgeting, savings, and financial management. Payscribe will select a group of ambassadors based on their qualifications, passion, and commitment to promoting financial wellness.</p>
