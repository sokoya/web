...
import CTAImg from "../assets/cta/payscribe_web.png";
    ...
    <section className=" mb-[10rem] px-[2rem] mx-auto sm:py-[1rem] mt-[2rem] sm:mt-[4rem] block ">
      <div className="flex  flex-wrap items-center sm:h-[50vh]  md:h-[60vh]">
        <div className="w-full sm:w-[40%] sm:px-[3rem]  mb-[3rem] sm:mb-0 text-center sm:text-left">
          ...
          <p className="mb-8">
            You can create an account directly from the <a href="https://app.payscribe.ng/auth/create/">web</a>, or download
          ...
          <div className="flex flex-row items-center justify-center flex-shrink-0 mt-6 space--4 gap-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:mt-0 lg:justify-start">
           <button className="inline-flex items-center px-6 py-3 rounded-lg bg-primary2 text-white">
          ...
          <a target="_blank" href="https://apple.co/3y7gi0x" className="inline-flex items-center px-5 py-3 rounded-lg bg-primary2 text-white">
