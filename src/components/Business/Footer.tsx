...
const Footer = (props: Props) => {
  return (
    <>
   <footer className="bg-gradient-to-b from-transparent to-gray-100 py-12 darrk:to-gray-900">
  <div className="mx-auto max-w-6xl px-6 md:px-12 lg:px-6 xl:px-0">
    {/* <a href="#home" aria-label="logo" className="flex items-center justify-center space-x-2">
      <div aria-hidden="true" className="flex flex-col space-y-0.5">
        <div className="h-0 w-0 border-l-[12px] border-r-[12px] border-b-[20px] border-transparent border-b-gray-900 darrk:border-b-white" />
    ...
    <div className="m-auto mt-4 flex w-max items-center justify-between space-x-4 text-gray-500">
      <a className="duration-300 hover:text-gray-600 darrk:hover:text-white" href="https://twitter.com/@tailus_ui" title="twitter" target="blank" aria-label="twitter">
      ...
      <a className="duration-300 hover:text-gray-600 darrk:hover:text-white" href="#" title="facebook" target="blank" aria-label="facebook">
      ...
      <a className="duration-300 hover:text-gray-600 darrk:hover:text-white" href="#" title="linkedin" target="blank" aria-label="linkedin">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="m-auto w-5" viewBox="0 0 16 16">
    ...
    <div className="mt-12 text-center">
      <span className="text-sm tracking-wide text-gray-500">Copyright © PAYSCRIBE 2018 - Present | All rights reserved</span>
    </div>
  </div>
</footer>
