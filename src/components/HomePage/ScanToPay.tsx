    ...
    <section className="mt-[4rem] rounded-lg bg-gradient-to-b from-[#D5D1FF] to-[#E9E9E9]">
      <div className="flex flex-row-reverse sm:flex-row flex-wrap items-center py-[2rem] px-[1rem] sm:px-[3rem]">
        <div className="w-full sm:w-[50%]">
          <h1 className="text-[1.5rem] sm:text-[3.5rem] text-center sm:text-left sm:mb-14 mb-4 font-bold sm:font-semibold leading-[1.7rem] sm:leading-[4rem]">
            Scan and Accept payments instantly{" "}
          </h1>
          <p className="mt-0 mb-3 text-gray-600 text-md pr-5 text-center sm:text-left">Empower your business with the right tools to transact anywhere while boosting your revenue.</p>
