...
<div className="relative  pb-2 pt-[5rem] bg-headerBg px-[2rem]" style={{background: `url('${bg}')`}}>
  ...
  alt="Avatar" />        
  <h2 className="mt-3 mb-1 text-3xl font-bold text-gray-800">AYOMIDE OLOYEDE</h2>
  ...
  <div className="option">
    <input type="radio" name="card" id="silver" defaultValue="silver" checked={check == 1} onChange={(e) => {setCheck(1); setIndex(2);}} />
        ...
        <div className="card__content">
          ...
          <div className="card__symbol">
            ...
            <span />
                ...
                <svg xmlns="http://www.w3.org/2000/svg" style={{justifySelf: "flex-end"}} xmlnsXlink="http://www.w3.org/1999/xlink" width="35px" height="35px" viewBox="0 0 24 24" version="1.1">
  <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
    <rect x={0} y={0} width={24} height={24} />
    <path d="M3.95709826,8.41510662 L11.47855,3.81866389 C11.7986624,3.62303967 12.2013376,3.62303967 12.52145,3.81866389 L20.0429,8.41510557 C20.6374094,8.77841684 21,9.42493654 21,10.1216692 L21,19.0000642 C21,20.1046337 20.1045695,21.0000642 19,21.0000642 L4.99998155,21.0000673 C3.89541205,21.0000673 2.99998155,20.1046368 2.99998155,19.0000673 L2.99999828,10.1216672 C2.99999935,9.42493561 3.36258984,8.77841732 3.95709826,8.41510662 Z M10,13 C9.44771525,13 9,13.4477153 9,14 L9,17 C9,17.5522847 9.44771525,18 10,18 L14,18 C14.5522847,18 15,17.5522847 15,17 L15,14 C15,13.4477153 14.5522847,13 14,13 L10,13 Z" fill="#3362B0" />
  </g>
</svg>
    </label>
  </div>
  <div className="option">
    <input type="radio" name="card" id="royal" defaultValue="royal" checked={check == 2} onChange={(e) => {setCheck(2); setIndex(2);}}/>
  ...
  <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
    <rect x={0} y={0} width={24} height={24} />
    <path d="M8,2.5 C7.30964406,2.5 6.75,3.05964406 6.75,3.75 L6.75,20.25 C6.75,20.9403559 7.30964406,21.5 8,21.5 L16,21.5 C16.6903559,21.5 17.25,20.9403559 17.25,20.25 L17.25,3.75 C17.25,3.05964406 16.6903559,2.5 16,2.5 L8,2.5 Z" fill="#3362B0" opacity="0.3" />
    <path d="M8,2.5 C7.30964406,2.5 6.75,3.05964406 6.75,3.75 L6.75,20.25 C6.75,20.9403559 7.30964406,21.5 8,21.5 L16,21.5 C16.6903559,21.5 17.25,20.9403559 17.25,20.25 L17.25,3.75 C17.25,3.05964406 16.6903559,2.5 16,2.5 L8,2.5 Z M8,1 L16,1 C17.5187831,1 18.75,2.23121694 18.75,3.75 L18.75,20.25 C18.75,21.7687831 17.5187831,23 16,23 L8,23 C6.48121694,23 5.25,21.7687831 5.25,20.25 L5.25,3.75 C5.25,2.23121694 6.48121694,1 8,1 Z M9.5,1.75 L14.5,1.75 C14.7761424,1.75 15,1.97385763 15,2.25 L15,3.25 C15,3.52614237 14.7761424,3.75 14.5,3.75 L9.5,3.75 C9.22385763,3.75 9,3.52614237 9,3.25 L9,2.25 C9,1.97385763 9.22385763,1.75 9.5,1.75 Z" fill="#3362B0" fillRule="nonzero" />
  </g>
</svg>
  ...
  <div className="option">
    <input type="radio" name="card" id="dark" defaultValue="dark" checked={check == 3} onChange={(e) => {setCheck(3); setIndex(2);}}/>
  ...
  <div className="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
    ...
    <label htmlFor="bordered-radio-2" className="w-full py-4 ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">PAY WITH USSD</label>
            ...
            {index == 2 && check == 1? <div className="relative">
            <button onClick={() => {setIndex(1); setCheck(0);}} className="w-8 h-8 rounded-full mb-2 flex bg-blue-500 hover:bg-primary2 text-white" style={{alignItems: "center", justifyContent: "center"}}>
                            <FaArrowLeft/>
            </button>
            <p className="my-2">Transfer to the account details below.</p>
            <div className="">
              <div className="flex flex-col sm:flex-row justify-between items-center bg-gray-100 rounded-lg gap-4 px-4 py-1 md:p-3 md:px-4">
                <div>
                  <h2 className="text-primary2 text-xl md:text-2xl font-bold">3160020316</h2>
                  <p className="text-gray-600">WEMA BANK</p>
                </div>
                <a href="#" className="inline-block bg-primary2 hover:bg-secondary active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-4 py-3">
                ...
                <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                  <rect x={0} y={0} width={24} height={24} />
                  <path d="M6,9 L6,15 C6,16.6568542 7.34314575,18 9,18 L15,18 L15,18.8181818 C15,20.2324881 14.2324881,21 12.8181818,21 L5.18181818,21 C3.76751186,21 3,20.2324881 3,18.8181818 L3,11.1818182 C3,9.76751186 3.76751186,9 5.18181818,9 L6,9 Z" fill="#fff" fillRule="nonzero" />
                  <path d="M10.1818182,4 L17.8181818,4 C19.2324881,4 20,4.76751186 20,6.18181818 L20,13.8181818 C20,15.2324881 19.2324881,16 17.8181818,16 L10.1818182,16 C8.76751186,16 8,15.2324881 8,13.8181818 L8,6.18181818 C8,4.76751186 8.76751186,4 10.1818182,4 Z" fill="#fff" opacity="0.3" />
                </g>
              </svg>
            ...
            {index == 2 && check == 2? <div className="relative">
            <button onClick={() => {setIndex(1); setCheck(0);setBank("");}} className="w-8 h-8 rounded-full mb-2 flex bg-blue-500 hover:bg-primary2 text-white" style={{alignItems: "center", justifyContent: "center"}}>
                            <FaArrowLeft/>
            </button>
            <div>
            <label htmlFor="bank" className="inline-block text-gray-800 text-sm sm:text-base mb-2">Bank Name</label>
            <select onChange={(e) => setBank(e.target.value)} name="bank" className="w-full bg-gray-50 text-gray-800 border ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2">
              <option selected hidden={bank !== ""} value="">Select your bank</option>
            ...
            {bank !== ""? <div className="ussd__info mt-2"><p >Tap to dial this code</p> <a href="tel:*894*500*7056096988%23" className="text-primary2 text-md md:text-xl font-bold">
                *894*500*7056096988#
              </a></div> : ""}
            ...
            {index == 2 && check == 3? <div className="relative">
              <button onClick={() => {setIndex(1); setCheck(0);}} className="w-8 h-8 rounded-full mb-2 flex bg-blue-500 hover:bg-primary2 text-white" style={{alignItems: "center", justifyContent: "center"}}>
                            <FaArrowLeft/>
            </button>
            <h3 className="font-bold text-2xl">Scan QR CODE</h3>
            <p className="text-sm">Scan this QR Code in app to continue</p>
            <img className="mt-2" src={QR} style={{height: "250px"}} />
            </div> : ""}
