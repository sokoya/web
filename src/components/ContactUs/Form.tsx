...
const Form = (props: Props) => {
  return (
    <div className="bgg-[#efefef] bg-headerBg relative p-[40px] md:pt-[91px] md:pr-[98px] md:pb-[86px] md:pl-[92px] lg:mt-[120px] mt-[70px] lg:rounded-[58px] lg:mx-[3rem]">
        ...
        <div className="flex flex-col gap-8 mb-[15px] md:mb-[25px] lg:flex-row lg:gap-[50px] xl:gap-[98px]">
          ...
          <form className="flex-1" action="/">
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="text-md text-gray-500">By clicking contact us button, you agree our terms and policy,</p>
            </div>
          </form>
        </div>
      </div>
