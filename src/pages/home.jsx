                ...
                <div className="hero-props-main mt_5">
                    <div className="cover-div">
                        <div className="top-card-tile">
                            ...
                            <h2 ref={pushElementToRef} className="desktop-only">Comprehensive Financial <br /> Tools for All Users</h2>
                            <h2 ref={pushElementToRef} className="mobile-only">Comprehensive Financial Tools for All Users</h2>
                        </div>
                        {/* <div>
                            ...
                            <div className="hero-block-main main-story">
                                <div className="">
                                    <div className="grid-2">
                                        ...
                                        <div>
                                            <video src={TopVideo} playsInline loop autoPlay muted={true} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="grid-2 sec-content mt_3">
                            <div className="hero-block-main light">
                                <div className="block-video">
                                    <video src={LeftVideo} playsInline loop autoPlay muted={true} />
                                </div>
                            ...
                            <div className="hero-block-main dark">
                                <div className="block-video">
                                    <video src={RightVideo} playsInline loop autoPlay muted={true} />
                                </div>
                                <div className="mt_3 inner-box-padding">
                                    <h5 className="top-tag color">For Individuals</h5>
                                    <h3>Take Control of Your Finances.</h3>
                        ...
                        <div className="grid-2">
                            <div>
                                <div className="grid-top-disp">
                                    <div>
                                        <img src={PaymentLinkImg} alt="payment links" className="reports" />
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <p ref={pushElementToRef}>Freelancers and business professionals can effortlessly create payment links and share them
                                    with clients for easy transactions. These links offer multiple payment options and can be used globally. Here's
                                    what you can expect:</p>
                                <div className="mt_5">
                                    <ul>
                                        <li ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Free Payment Links</li>
                                        <li ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Multiple Payment Options</li>
                                        <li ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Global Usability</li>
                                        <li ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Streamlined Transactions</li>
                                        <li className="last-two" ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Professional Appearance</li>
                                        <li className="last-two" ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Increased Efficiency</li>
                                    </ul>
                                </div>
                                <div className="mt_10">
                    ...
                    <div className="cover-div">
                        <div className="grid-2 inverse">
                            <div>
                                ...
                                <p ref={pushElementToRef}>Take control of your finances with our advanced tracking and reporting tools. Understand your spending habits
                                    and make informed decisions to optimize your budget. Here’s how our features can help you:</p>
                                <div className="mt_5">
                                    <ul>
                                        <li ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Track Your Expenses</li>
                                        <li ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Manage Your Spending</li>
                                        <li ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Detailed Reports</li>
                                        <li ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Budget Optimization</li>
                                        <li className="last-two" ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Financial Clarity</li>
                                        <li className="last-two" ref={pushElementToRef}><ion-icon name="checkmark-done-circle-outline"></ion-icon> Audit Preparation</li>
                                    </ul>
                                </div>
                                <div className="mt_10">
                                    <Link style={{ width: "max-content" }} to="" className="btn btn-main">Create an Account For Free</Link>
                            ...
                            <div>
                                <img src={PaymentLink2Img} alt="payment links" className="reports" />
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="grid-2" style={{ alignItems: "center" }}>
                                ...
                                <div>
                                    <p ref={pushElementToRef}>Payscribe simplifies financial management, providing intuitive tools and top-notch support for businesses and consumers
                                        alike. Our platform ensures secure, efficient, and hassle-free financial transactions. Payscribe simplifies
                                        financial management, providing intuitive tools.</p>
                                </div>
                            </div>
                        </div>
