                    ...
                    <div className="grid-2">
                        <div className="text-ba">
                            <div className="text-bar">
                                ...
                                <h2>Transforming Financial Management for You and Your Business.</h2>
                                <p>Experience a new era of financial control with Payscribe. Whether you're managing personal finances or 
                                    running a business, our tailored solutions streamline transactions, optimize operations, and support your 
                    ...
                    <div className="contain">
                        <div className="grid-2">
                            <div>
                                ...
                                <h2>Make authentication easy for everyone and easily without hassle</h2>
                                <p ref={pushElementToRef}>Take control of your finances with our advanced tracking and reporting tools. Understand your spending habits
                                    and make informed decisions to optimize your budget. Here’s how our features can help you. Take control of
                                    your finances with our advanced tracking and reporting tools. Take control of
                                    your finances with our advanced tracking and reporting tools.</p>
                                <div>
                                    <ul>
                                        <li>
                                            <h4>500K+</h4>
                        ...
                        <div className="grid-3">
                            <div>
                                <div className="single-advantage-data">
                                    ...
                                    <h4>Tackle authentication globally</h4>
                                    <p ref={pushElementToRef}>Take control of your finances with our advanced tracking and reporting tools. Understand your spending habits
                                        and make informed decisions to optimize your budget.</p>
                                </div>
