        ...
        <div className="grid-2">
          <div className="text-ba">
            <div className="text-bar">
              ...
              <p>
                Pay your bills quickly and securely with our easy-to-use
                service. Manage your regular expenses with ease, track payments
                effortlessly, and enjoy a smooth, hassle-free experience. Stay
                on top of your bills without any stress or complications.
              </p>
            ...
            <div className="grid-3 props">
              ...
              <div>
                ...
                <p>
                  Effortlessly track and manage all your bills in one place.
                  Stay organized, avoid missed payments, and enjoy the
                  convenience of our reliable service, keeping your finances in
                  check.
                </p>
              </div>
              <div>
                ...
                <p>
                  Pay your bills with confidence. Our secure and reliable
                  service ensures that every transaction is safe and dependable,
                  making it easy for you to manage your payments with peace of
                  mind.
                </p>
              </div>
            </div>
        ...
        <div className="contain mt_5">
          <div className="desktop-only">
            <h3 className="sec-title">
              Get the Most Out of Your Bill <br /> Payments with Our Easy
              Solutions
            </h3>
          </div>
          <div className="mobile-only">
            <h3 className="sec-title">
              Get the Most Out of Your Bill Payments with Our Easy Solutions
            </h3>
          </div>
          <div className="grid-3 how-to mt_2">
            ...
            <div className="how-to-single">
              ...
              <div className="how-to-story mt_5">
                ...
                <p>
                  After creating your account, navigate to the "Bill Payments"
                  section. Select the bill payment plan that suits your needs,
                  and enter the required details to proceed. It's simple and
                  straightforward!
                </p>
              </div>
            </div>
            <div className="how-to-single">
              ...
              <div className="how-to-story mt_5">
                ...
                <p>
                  Finally, enter your card details and complete your payment.
                  Input your payment information carefully, review the details,
                  and confirm the transaction to finalize the payment process.
                </p>
              </div>
            </div>
          </div>
