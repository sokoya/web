                ...
                <div className="grid-2">
                    <div className="text-ba">
                        <div className="text-bar">
                            ...
                            <p>Easily find the best deals on gift cards and turn your unused cards into cash. Our platform ensures a
                                secure and hassle-free experience, whether you're buying or selling. Maximize your savings and earn
                                extra money with every transaction.</p>
                ...
                <div className="contain">
                    <div className="grid-3">
                        <div>
                            ...
                            <p>Explore a diverse selection of gift cards tailored to suit all your needs and preferences. Whether you're
                                looking for the perfect card for yourself or a gift for someone else, you'll find plenty of options.</p>
                        </div>
                        <div>
                            <ion-icon name="diamond-outline"></ion-icon>
                            <h4>Competitive Buy and Sell Rates</h4>
                            <p>Enjoy rates that guarantee you get the best value for your gift cards. With our service, you can
                                maximize your earnings with every transaction, ensuring you always make the most out of your cards.</p>
                        </div>
                        <div>
                            <ion-icon name="lock-closed-outline"></ion-icon>
                            <h4>Secure and Easy Transactions</h4>
                            <p>Experience secure transactions with Payscribe. Your data and funds are always protected, giving you
                                peace of mind. Enjoy the convenience and safety of managing your transactions confidently.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid-3 mt_2">
                        ...
                        <div className="how-to-single">
                            ...
                            <div className="how-to-story mt_5">
                                ...
                                <p>After creating your account, go to the "Gift cards" section. Choose the type of gift card you want to sell, and 
                                    enter the necessary details to get started. It's easy and straightforward!</p>
                            </div>
                        </div>
                        <div className="how-to-single">
                            <div className="how-to-img"></div>
                            <div className="how-to-story mt_5">
                                ...
                                <p>Finally, enter your gift card amount and proceed to complete the transaction. Carefully input the details of 
                                    your gift card, review all the information, and confirm to finalize the buy or sell process.</p>
                            </div>
                        </div>
                    </div>
                </div>
