    ...
    <div>
        ...
        <div className="grid-2">
          <div className="text-ba">
            <div className="text-bar">
              ...
              <h2>
                Global Payments Made Easy: Send and Receive Money Anywhere.
              </h2>
              <p>
                Send and receive payments anywhere in the world effortlessly.
                Our platform makes international transactions simple and secure,
                ensuring your money moves quickly and reliably, no matter where
                you are.
              </p>
      ...
      <div className="summary-block py_5">
            ...
            >
              <SwiperSlide key={1}>
                <div>
                  ...
                  <p>
                    ...
                    ensuring your funds reach their destination efficiently.
                    Enjoy a seamless and reliable process for all your global
                    financial needs.
                  </p>
                </div>
              </SwiperSlide>
              <SwiperSlide key={2}>
                <div>
                  ...
                  <p>
                    Benefit from our low transfer fees for international
                    transactions. Enjoy affordable and secure money transfers,
                    with clear and transparent costs that help you save on every
                    transfer.
                  </p>
                </div>
              </SwiperSlide>
              <SwiperSlide key={3}>
                <div>
                  ...
                  <p>
                    Easily manage your funds with our multi-currency support.
                    Transfer and receive money in various currencies with ease,
                    all while enjoying seamless transactions and competitive
                    exchange rates.
                  </p>
                </div>
              </SwiperSlide>
          ...
          <div className="desktop-only">
            <div className="grid-3">
              <div>
                ...
                <p>
                  Send and receive money across borders quickly and securely,
                  ensuring your funds reach their destination efficiently. Enjoy
                  a seamless and reliable process for all your global financial
                  needs.
                </p>
              </div>
              <div>
        ...
        <div className="contain mt_5">
          ...
          <div className="grid-3 mt_2 how-to">
            ...
            <div className="how-to-single">
              ...
              <div className="how-to-story mt_5">
                ...
                <p>
                  After creating your account, go to the "Transfers" section.
                  Choose the type of transfer you want to make, and enter the
            ...
            <div className="how-to-single">
              ...
              <div className="how-to-story mt_5">
                ...
                <p>
                  Finally, enter your transfer amount and proceed to complete
                  the transaction. Carefully input the transfer details, review
                  all the information to be sure, and confirm to finalize the
                  process.
                </p>
              </div>
            </div>
