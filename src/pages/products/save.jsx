    ...
    <div>
        ...
        <div className="grid-2">
          <div className="text-ba">
            <div className="text-bar">
              ...
              <h2>
                Smart Savings: Save More Efficiently and Watch Your Earnings
                Grow.
              </h2>
              <p>
                Boost your savings effortlessly with our smart plans. Track your
                progress and watch your money grow over time with easy,
                effective saving strategies. Start today and see your earnings
                increase with minimal effort!
              </p>
      ...
      <div className="summary-block py_5">
        <div className="contain">
          <Swiper centeredSlides={false} loop={false} breakpoints={breakpoints}>
            <SwiperSlide key={1}>
              <div>
                <ion-icon name="expand-outline"></ion-icon>
                <h4>Flexible Savings Plans</h4>
                <p>
                  Our plans are tailored to fit your lifestyle, giving you the
                  freedom to save at your own pace. Whether you're saving for a
                  short or long-term goal, our plans make it easy and convenient
                  to stay on track.
                </p>
              </div>
            </SwiperSlide>
            <SwiperSlide key={2}>
              <div>
                ...
                <p>
                  Receive expert investment advice tailored to your financial
                  goals. Our experienced advisors provide personalized insights
                  and strategies designed to help you make informed decisions.
                </p>
              </div>
            </SwiperSlide>
            <SwiperSlide key={3}>
              <div>
                ...
                <p>
                  Benefit from high-interest returns that boost your investment
                  growth, making your money work harder for you. With these
                  higher rates, you can see faster progress towards your
                  financial goals.
                </p>
              </div>
            </SwiperSlide>
        ...
        <div className="contain mt_5">
          <h3 className="sec-title">
            Unlock the Full Potential <br /> of Your Savings and Earnings
          </h3>
          <div className="grid-3 how-to mt_2">
            ...
            <div className="how-to-single">
              ...
              <div className="how-to-story mt_5">
                ...
                <p>
                  After creating your account, go to the "Investments" section.
                  Choose an investment plan that fits your goals, and enter the
            ...
            <div className="how-to-single">
              ...
              <div className="how-to-story mt_5">
                ...
                <p>
                  Finally, enter your investment amount and proceed to complete
                  the transaction. Carefully input your investment details,
                  review all the information, and confirm to finalize your
                  investment process.
                </p>
              </div>
            </div>
