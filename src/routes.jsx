			...
			<BrowserRouter>
				<Wrapper>
					<Routes>
						...
						<Route
							path={AppRoutes.airtime_to_cash}
							element={<AirtimeToCashPage />}
						/>
						<Route
						...
						/>
						<Route
							path={AppRoutes.handle_payments}
						...
						/>
						<Route
							path={AppRoutes.sell_giftcards}
							element={<GiftcardsPage />}
						/>
						<Route
							path={AppRoutes.save_and_earn}
							element={<SaveAndEarnPage />}
						/>
