...
export function ComplaintPolicyHero() {
	...
	return (
		<section className='business-hero relative overflow-hidden'>
			...
			>
				...
				>
					We take every complaint seriously. This policy explains how to raise
					a concern, how we will handle it, and what to do if you remain
				...
				>
					<Link href='#omplaints-content' className='inline-flex'>
						<motion.span
