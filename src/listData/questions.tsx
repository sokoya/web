...
export const questions = [
    ...
    items: [
      ...
      },
      {
        ...
        list: [
            ...
            {title: 'Save for a target, spend and save', markup: false},
            {title: 'Buy Airtime & Internet Data', markup: false},
            {title: 'Pay bills', markup: false},
            {title: 'Fund your gaming and sport wallet', markup: false},
    ...
    items: [
      {
        ...
        body: "Payment links is one of the easiest way to receive payments from your customers if you don’t have your own app or website. Payment Link can be shared with your customer via WhatsApp, SMS, email etc and upon clicking the link, your customers can pay you.",
        list: [
    ...
    items: [
      ...
      },
      {
        ...
        },
        {
          ...
          list: [],
          body: 'Yes! You can receive payment via the QR Code free of charge. This is also great for business owners. Your customers can pay by scanning the QRCode (Note the customer must be a payscribe user to use this service).',
        },
        {
  ...
  },
  {
    ...
    items: [
      {
        header: "Can I integrate Payscribe services on my website/mobile app?",
        body: "We've made it easy for you to accept payments, pay daily essential bills with just a few lines of code. Please see our developers section",
        list: []
      },
      {
        header: "Does Payscribe has sandbox?",
        body: "Yes we do, Please change the API mode to 'Test Mode' and use the sandbox API token. This will allow you to test all Payscribe servies and get accurate results without using any real money. You should switch to live mode when satisfied with your integration.",
        list: []
      },
      {
        header: "Does Payscribe has SDK",
        body: "Software Development Kit (SDK). Yes we have for different languages.",
        list: []
      },
      {
        header: "I have a feature request how do I contact Payscribe?",
        body: "We are very open, kindly reach out to us on hello@payscribe.ng",
        list: []
      },
      {
        header: "How do I get support when I am stuck with the development.",
        body: "Sorry about that, we will be glad to help, please send us a mail hello@payscribe.ng",
        list: []
      },
    ]
  }
