import ikedc from "../assets/bills/electricity/ikedc.png";
...
export const billsList = [
  {
    header: "Electricity bills Subscription",
    images: [ikedc, phedc, aedc, ibedc, jedc, ekedc],
  },
  {
    header: "TV subscriptions",
    images: [showmax, multichoice, startimes],
  },
  {
    header: "Betting Wallet",
    images: [
      bet9ja,
      onexbet,
      bangbet,
