...
import PCIAudit from '/assets/exports/pci-audit.png'
...
const lists = [
  {
    ...
    items: [
      ...
      { title: 'Bills Payments', link: '/?tab=bill-payments' },
      { title: 'Digital Payments', link: '/payout/?tab=digital-payments' },
  ...
  return (
    <div className="">
      <div className="relative bg-black px-2 py-1 text-sm overflow-hidden">
        <img
          src={Overlay}
          className="absolute md:top-[10%] blue-filter transform rotate-[10deg] md:opacity-5 opacity-5 top-[50%] glower mx-auto md:h-[80%] h-[40%] md:left-[60%] left-[12%] "
        />
      ...
      /> */}
        <div className="bg-black grid md:grid-cols-[2fr_3fr] grid-cols-1 md:p-10 p-2 ">
          <div className="md:m-5 m-1">
            ...
            <div className="z-20 md:my-5 my-10">
            <p className="text-slate-300 text-sm md:p-3 p-1 ">
              ...
              financial services to their customers. Also available for
              individuals.
            </p>
            ...
            <div className="md:flex grid grid-cols-2 text-white text-2xl md:justify-start justify-center">
              <img src={Audit} className="h-[2em] px-2" alt="NDPR" />              
              <img src={PCIAudit} className="h-[2em] px-2" alt="PCI DSS certified" />
            </div>
            <br />
            <div className="md:flex grid grid-cols-2 text-white text-2xl md:justify-start justify-center">
            ...
            <div className="text-white p-3 grid grid-cols-2  md:grid-cols-4 relative md:my-10 my-0">
              {lists.map((listObj) => (
                <div key={listObj.title} className="md:my-0 my-5">
                  <h2 className="font-semibold text-md md:text-left text-center">
                    {listObj.title}
                  </h2>
                  <div className="text-slate-400 text-sm md:my-5 my-2">
                    {listObj.items.map((item, index) => (
                      <div
                        key={index}
                        className="my-4 md:text-left text-center"
                      >
